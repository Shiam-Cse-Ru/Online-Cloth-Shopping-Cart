...
<div id="wrapper">
  ...
  <div id="content">
    ...
    <p align="justify" class="style10">Shopping Address Detail</p>
    ...
    <table width="100%" border="0">
      ...
      <?php do { ?>
        <tr>
         <td bgcolor="#a980d5"><strong>CustomerName</strong></td> 
        <td bgcolor="#a980d5"><?php echo $row_Recordset1['CustomerName']; ?></td></tr>
        <tr>  <td bgcolor="#d1bae8"><strong>Address</strong></td>  
        <td bgcolor="#d1bae8"><?php echo $row_Recordset1['Address']; ?></td></tr>
        <tr> <td bgcolor="#a980d5"><strong>City</strong></td> 
        <td bgcolor="#a980d5"><?php echo $row_Recordset1['City']; ?></td></tr>
       <tr>  <td bgcolor="#d1bae8"><strong>Email</strong></td> 
       <td bgcolor="#d1bae8"><?php echo $row_Recordset1['Email']; ?></td></tr>
        <tr> <td bgcolor="#a980d5"><strong>Mobile</strong></td>  
        <td bgcolor="#a980d5"><?php echo $row_Recordset1['Mobile']; ?></td></tr>
        <tr> <td bgcolor="#d1bae8"><strong>Gender</strong></td> 
        <td bgcolor="#d1bae8"><?php echo $row_Recordset1['Gender']; ?></td>
        </tr>
