...
<div id="wrapper">
  ...
  <div id="content">
    ...
    <table width="100%" border="1" bordercolor="#a980d5" >
      <tr>
        <td bgcolor="#a980d5" class="style10 style3"><strong>ID</strong></td>
        <td bgcolor="#a980d5" class="style10 style3"><strong>Customer Name</strong></td>
        <td bgcolor="#a980d5" class="style10 style3"><strong>Item Name</strong></td>
       
        <td bgcolor="#a980d5" class="style10 style3"><strong>Quantity</strong></td>
        <td bgcolor="#a980d5" class="style10 style3"><strong>Price</strong></td>
        <td bgcolor="#a980d5" class="style10 style3"><strong>Total</strong></td>
      
        <td bgcolor="#a980d5" class="style10 style3"><strong>Shipping Address</strong></td>
      </tr>
      <?php
	  session_start();
