...
<div id="wrapper">
  ...
  <div id="content">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="27" bgcolor="#a980d5"><span class="style10"><strong>Create New Category</strong></span></td>
      </tr>
      <tr>
      ...
      <tr>
        <td height="25" bgcolor="#a980d5"><span class="style10"><strong>Category List</strong></span></td>
      </tr>
      <tr>
        <td><table width="100%" border="1" bordercolor="#a980d5" >
            <tr>
              <th height="32" bgcolor="#d1bae8" class="style3"><div align="left" class="style9 style5"><strong>Id</strong></div></th>
              <th bgcolor="#d1bae8" class="style3"><div align="left" class="style9 style5"><strong>Category Name</strong></div></th>
              <th bgcolor="#d1bae8" class="style3"><div align="left" class="style9 style5"><strong>Description</strong></div></th>
              <th bgcolor="#d1bae8" class="style3"><div align="left" class="style9 style5"><strong>Edit</strong></div></th>
              <th bgcolor="#d1bae8" class="style3"><div align="left" class="style12">Delete</div></th>
            </tr>
            <?php
