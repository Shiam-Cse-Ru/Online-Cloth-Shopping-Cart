...
<div id="wrapper">
  ...
  <div id="content">
    ...
    <table width="100%" height="364" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td height="27" bgcolor="#a980d5">&nbsp;</td>
      </tr>
      <tr>
        <td>&nbsp;
          <table width="100%" border="1" cellpadding="2" cellspacing="2" bordercolor="#a980d5">
            <tr>
              <td bgcolor="#a980d5"><span class="style12">ItemId</span></td>
              <td bgcolor="#a980d5"><span class="style12">ItemName</span></td>
              <td bgcolor="#a980d5"><span class="style12">Size</span></td>
              <td bgcolor="#a980d5"><span class="style12">Image</span></td>
              <td bgcolor="#a980d5"><span class="style12">Price</span></td>
              <td bgcolor="#a980d5"><span class="style12">Discount</span></td>
              <td bgcolor="#a980d5"><span class="style12">Total</span></td>
            </tr>
            <?php do { ?>
              <tr>
